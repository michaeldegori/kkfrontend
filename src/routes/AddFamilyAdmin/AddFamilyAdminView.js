...
const AddFamilyAdminView = ({
  ...
  >
    ...
    >
      ...
      >
        Important note: you can only add a family admin if they don't already
        have a Kiddie Kredit account under that email (the operation will fail).
        You can add them under another email they haven't yet registered, and
        they can then complete the registration process with that email.
      </Text>
      <KKButton type={'primary'} onPress={onSubmitAdmin} disabled={submitting}>
