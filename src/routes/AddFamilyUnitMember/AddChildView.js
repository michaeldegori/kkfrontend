        ...
        >
          ...
          <View style={styles.inputAndButtons}>
            ...
            <Row style={{ paddingRight: width * 0.06 }}>
              ...
              <Picker
                style={[styles.picker, styles[`picker${Platform.OS}`]]}
                selectedValue={dobM}
                onValueChange={(v) => onChangeText('dobM', v)}
                itemStyle={[
                  styles.pickerItem,
                  Platform.OS === 'ios' ? styles.pickerItemIOSStyle : {},
                ]}
              >
                {Platform.OS !== 'ios' && (
                  <Picker.Item label="MM" enabled={false} value="" />
                )}
                {Array(12)
                  .fill('')
                  .map((_, i) => (
              ...
              >
                {Platform.OS !== 'ios' && (
                  <Picker.Item label="DD" enabled={false} value="" />
                )}
                {Array(31)
                  .fill('')
                  .map((_, i) => (
              ...
              >
                {Platform.OS !== 'ios' && (
                  <Picker.Item label="YY" enabled={false} value="" />
                )}
                {Array(14)
                  .fill('')
                  .map((_, i) => (
            ...
            <KKButton type="secondary" to="/maintabscreen/accountmanager">
              QUIT
            </KKButton>
          </View>
